...
in {
  ...
  nixpkgs.config.permittedInsecurePackages = lib.mkIf (my-system.enableMatrixServer or false) [
    "olm-3.2.16"
  ];
  ...
  systemd.services.lk-jwt-service = lib.mkIf (my-system.enableMatrixServer or false) {
    environment.LIVEKIT_FULL_ACCESS_HOMESERVERS = "matrix.jonbyr.com";
  };
  ...
  systemd.services.tuwunel = lib.mkIf (my-system.enableMatrixServer or false) {
  ...
  services.nginx = {
    ...
    virtualHosts."matrix.jonbyr.com" = {
      enableACME = true;
      forceSSL = true;
      locations."/" = {
    ...
    virtualHosts."matrix-rtc.jonbyr.com" = {
      enableACME = true;
      forceSSL = true;
  ...
  networking.firewall = {
    ...
    allowedTCPPorts =
      ...
      ++ (lib.optionals (my-system.enableMatrixServer or false) [7881 3478]);
    allowedUDPPorts = lib.optionals (my-system.enableMatrixServer or false) [3478];
    allowedUDPPortRanges = lib.optionals (my-system.enableMatrixServer or false) [
      {
        from = 50100;
        to = 50200;
